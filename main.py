...
Выдай ОДИН нумерованный список кадров в порядке важности, покрывающий все 6 деталей чек-листа: 01 Упаковка и полиграфия, 02 Тара и литьё, 03 Маркировка и батч-код, 04 Продукт внутри, 05 Механизмы и фурнитура, 06 Комплектация и защита.

Правила списка:
- Если «да» или «не знаю» — включай коробочные кадры, каждый помечай «(при наличии)».
...
"Как это работает:\n"
"1. Напишите бренд и название продукта — бот составит список кадров под продукт.\n"
"2. По шагам соберём кадры по всем 6 деталям чек-листа (коробочные — при наличии).\n"
...
FALLBACK_BOX=["Батч-код на таре (макро)","Лицо тары (общий вид)","Батч-код на коробке (макро) (при наличии)","Лицо коробки (при наличии)","Текстура на белом листе (макро)","Крышка и мембрана/пломба"]
FALLBACK_NOBOX=["Батч-код на таре (макро)","Лицо тары (общий вид)","Текстура на белом листе (макро)","Крышка и мембрана/пломба"]
